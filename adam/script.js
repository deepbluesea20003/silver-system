    ...
    document.getElementById('genButton').addEventListener('click', function() {
        fetch('https://api.breakingbadquotes.xyz/v1/quotes') // Replace 'https://api.example.com/data' with your API endpoint
            ...
            .then(function(data) {
                ...
                let imgLink = images[author];
                console.log(imgLink);
                if(imgLink===undefined){imgLink = "https://th.bing.com/th/id/OIP.m4SW8m_wQgcOX75ayigSjgHaI_?pid=ImgDet&rs=1"}
                document.getElementById('mainImg').src = imgLink
            })
